...
HELP_STRING = f"★ ™°‌ 🫧 🇲 🇦 𝐀 𝐃 𝐀 𝐑 𝐀 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★\n\n» **𝙲𝙻𝙸𝙲𝙺 𝙾𝙽 𝙱𝙴𝙻𝙾𝚆 𝙱𝚄𝚃𝚃𝙾𝙽 𝙵𝙾𝚁 𝙷𝙴𝙻𝙿**\n» **𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁: @CODEX_MADARA**"
...
HELP_BUTTON = [
    ...
    [
      ...
      Button.url("💖 s𝚞𝚙𝚙𝚘𝚛𝚃 💖", "https://t.me/TEAM_DST")
    ]
  ]
    ...
    if event.query.user_id in SUDO_USERS:    
        await event.edit(
            ...
            buttons=[
              ...
              [
                Button.url("💘 𝙾𝚡𝚢𝚐𝚎𝙽 💘", "https://t.me/CODEX_MADARA"),
                Button.url("💫 𝚂𝚞𝚙𝚙𝚘𝚛𝚃 💫", "https://t.me/TEAM_DST")
              ]
            ]
          )
    else:
        await event.answer("𝙼𝙰𝙳𝙰𝚁𝙰 𝚂𝙴 𝙹𝙰 𝙺𝙴 𝚂𝚄𝙳𝙾 𝙻𝙴𝙻𝙾  @CODEX_MADARA" , cache_time=0, alert=True)
